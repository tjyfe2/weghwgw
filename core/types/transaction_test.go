...
var (
	...
	signedEip2718Tx, _ = NewAccessListTransaction(
		...
		common.Hex2Bytes("db2ac1e57586f3a8937e74e8780a01f1f5ce9b3b12e42ecfc7b7fd9fba032cd4779384dc5da2a7c1fa4d91264d1cb1cc8d321edcdde72ce0deedc7e294a98ec401"),
	)
)
...
func TestEIP2718TransactionSigHash(t *testing.T) {
	...
	if yolo.Hash(emptyEip2718Tx) != common.HexToHash("49b486f0ec0a60dfbbca2d30cb07c9e8ffb2a2ff41f29a1ab6737475f6ff69f3") {
		t.Errorf("empty EIP-2718 transaction hash mismatch, got %x", yolo.Hash(emptyEip2718Tx))
	}
	if yolo.Hash(signedEip2718Tx) != common.HexToHash("49b486f0ec0a60dfbbca2d30cb07c9e8ffb2a2ff41f29a1ab6737475f6ff69f3") {
		t.Errorf("signed EIP-2718 transaction hash mismatch, got %x", yolo.Hash(signedEip2718Tx))
	}
}
...
func TestEIP2718TransactionEncode(t *testing.T) {
	...
	should := common.FromHex("01f8630103018261a894b94f5374fce5edbc8e2a8697c15331677e6ebf0b0a825544c001a0db2ac1e57586f3a8937e74e8780a01f1f5ce9b3b12e42ecfc7b7fd9fba032cd4a0779384dc5da2a7c1fa4d91264d1cb1cc8d321edcdde72ce0deedc7e294a98ec4")
	if !bytes.Equal(txb, should) {
