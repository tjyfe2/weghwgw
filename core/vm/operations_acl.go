...
var (
	gasCallEIP2929         = makeCallVariantGasCalEip2929(gasCall)
	gasDelegateCallEIP2929 = makeCallVariantGasCalEip2929(gasDelegateCall)
	gasStaticCallEIP2929   = makeCallVariantGasCalEip2929(gasStaticCall)
	gasCallCodeEIP2929     = makeCallVariantGasCalEip2929(gasCallCode)
)
