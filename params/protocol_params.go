...
const (
	...
	TxAccessListAddress      uint64 = 2400  // Per address specified in EIP 2930 access list
	TxAccessListStorageKey   uint64 = 1900  // Per storage key specified in EIP 2930 access list
	...
	BatchTxCost uint64 = 17000 // Gas price for EIP-2733 batch transaction
	ChildTxGas  uint64 = 8000  // Gas price for EIP-2733 child transaction
)
