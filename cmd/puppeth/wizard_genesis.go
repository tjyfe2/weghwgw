...
func (w *wizard) manageGenesis() {
	...
	case "1":
		...
		fmt.Println()
		fmt.Printf("Which block should Aleut come into effect? (default = %v)\n", w.conf.Genesis.Config.AleutBlock)
		w.conf.Genesis.Config.AleutBlock = w.readDefaultBigInt(w.conf.Genesis.Config.AleutBlock)
